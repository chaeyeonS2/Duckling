    ...
    <header className={styles.header}>
      ...
      >
        <img
          src={
            currentTab === "인기"
              ? process.env.PUBLIC_URL + "/img/looking/popular.png"
              : process.env.PUBLIC_URL + "/img/looking/popular_non.png"
          }
        ></img>
        <text>인기</text>
      </div>
      ...
      >
        <img
          src={
            currentTab === "최신"
              ? process.env.PUBLIC_URL + "/img/looking/new.png"
              : process.env.PUBLIC_URL + "/img/looking/new_non.png"
          }
        ></img>
        <text>최신</text>
      </div>
